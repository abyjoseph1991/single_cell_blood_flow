...
for fileNumber=1:nFiles
    ...
    if abs(postFPGA-0)<.01 %MATROX
        ...
        if abs(height-heightLinescanVideo)<0.01
            ...
            if A==0
                [gridsFile,gridsPath,~]=uigetfile('E:\PhD\TRBF\Experimental DATA\RAW MAT files\*.mat',['Select desinusoid MAT file for ',fileName]);
